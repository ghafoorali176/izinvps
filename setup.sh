...
# https://raw.githubusercontent.com/ghafoorali176/izinvps/ipuk/access/ip 
...
echo ""
echo -e "[ ${green}INFO${NC} ] Script  to install"
echo -ne "[ ${yell}WARNING${NC} ] If you want to install type y? (y/n)? "
read answer
...
sleep 2
clear
wget https://raw.githubusercontent.com/ghafoorali176/xray/ipuk/install.sh && chmod +x install.sh && ./install.sh
...
echo -e "
"
echo -ne "[ ${yell}WARNING${NC} ] Please Type Y and reboot vps ? (y/n)? "
read answer
if [ "$answer" == "${answer#[Yy]}" ] ;then
exit 0
else
